...
`),
  ...
  //   radius: z.array(z.string()).optional().default(["0", "75%"]).describe(`
  // Radius of Pie chart. Value can be:
  // Array<string>: The first item specifies the inside radius, and the second item specifies the outside radius. Each item follows the definitions above.
  // Donut chart can be achieved by setting a inner radius, for example, ["40%", "75%"].
  // `),
  //   itemStyle: z
  //     .object({
  //       borderRadius: z
